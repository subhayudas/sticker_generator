...
function Hero({ onScrollToGenerator }: HeroProps) {
  return (
    <section className="py-20 px-4 text-center bg-gradient-to-r from-purple-100 to-pink-100">
      <div className="max-w-4xl mx-auto">
        ...
        <button
          ...
          className="px-8 py-4 bg-purple-600 text-white rounded-full text-lg font-semibold hover:bg-purple-700 transform hover:scale-105 transition-all"
        >
