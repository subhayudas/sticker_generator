...
function Gallery() {
  return (
    <section id="gallery" className="py-12 md:py-20 bg-gradient-to-br from-purple-50 to-pink-50">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-12 md:mb-16">Sticker Gallery</h2>
